...
namespace ImGui
{
	...
	IMGUI_API ImVec4        GetContentsRegionRectbyName(const char* name);			// get window rect 
	...
	//imgui-node-editor的blueprint中用到的扩展imgui的函数
    ...
    IMGUI_API bool TreeNodeEx(const char* label, ImGuiTreeNodeFlags flags = 0, ImTextureID id = nullptr,
                              ImVec2 size = ImVec2(0, 0), bool checkable = false, bool cur_checked = false,
                              bool sub_checked = false, bool* output_checked = nullptr);
	...
	IMGUI_API bool          IsMouseRightDown();
	IMGUI_API bool          IsMouseLeftDown();
...
enum ImGuiCol_
{
    ...
    ImGuiCol_PlotLines,
	ImGuiCol_PlotLines_1,
	ImGuiCol_PlotLines_2,
	ImGuiCol_PlotLines_3,
	ImGuiCol_PlotLines_4,
	ImGuiCol_PlotLines_5,
	ImGuiCol_PlotLines_6,
	ImGuiCol_PlotLines_7,
	ImGuiCol_PlotLines_8,
	ImGuiCol_PlotLines_9,
...
enum ImGuiStyleVar_
{
	...
	ImGuiStyleVar_LayoutAlign,         // float     LayoutAlign 有没有貌似都无所谓 
    ImGuiStyleVar_COUNT
...
struct ImDrawList
{
	...
	float                   _FringeScale;       // [Internal] anti-alias fringe is scaled by this value, this helps to keep things sharp while zooming at vertex buffer content 抗锯齿条纹缩放
    ...
    IMGUI_API void  AddCircle(const ImVec2& centre, float radius, ImU32 col, int num_segments = 12, float thickness = 1.0f);
		IMGUI_API void  AddEllipse(const ImVec2& centre, float scale_x, float scale_y, float radius, ImU32 col, int num_segments = 32, float thickness = 1.0f);
		IMGUI_API void  AddDashedEllipse(const ImVec2& centre, float scale_x, float scale_y, float radius, ImU32 col, int num_segments = 31, float thickness = 1.0f);
    ...
    IMGUI_API void  AddBezierCurve(const ImVec2& pos0, const ImVec2& cp0, const ImVec2& cp1, const ImVec2& pos1, ImU32 col, float thickness, std::vector<ImVec2>& retpos,int num_segments = 0);
	IMGUI_API void	AddHermiteCurve(const ImVec2& pos0, const float& outTan, const float& inTan, const ImVec2& pos1, ImU32 col, float thickness, std::vector<ImVec2>& retpos, int num_segments = 0);
    ...
    IMGUI_API void  PathArcTo(const ImVec2& centre, float radius, float a_min, float a_max, int num_segments = 10);
		IMGUI_API void  PathScaleArcTo(const ImVec2& centre, float scale_x, float scale_y, float radius, float a_min, float a_max, int num_segments = 10);
    IMGUI_API void  PathArcToFast(const ImVec2& centre, float radius, int a_min_of_12, int a_max_of_12);                                            // Use precomputed angles for a 12 steps circle
    IMGUI_API void  PathBezierCurveTo(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, std::vector<ImVec2>& retpos, int num_segments = 0);
	IMGUI_API void  PathHermiteCurveTo(const ImVec2& p1, const float& outTan, const float& inTan, const ImVec2& p2, std::vector<ImVec2>& retpos, int num_segments = 10);
