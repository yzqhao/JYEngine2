...
namespace ImGui
{
    ...
    IMGUI_API void          RenderCheckMark(ImVec2 pos, ImU32 col, float sz, float thickness = 0);
    ...
    IMGUI_API bool          TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL, ImTextureID image = nullptr,
