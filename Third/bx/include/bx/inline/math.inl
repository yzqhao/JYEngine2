...
namespace bx
{
    ...
    // TODO: modify source code build vs2015 winsdk
	inline Plane::Plane(init::NoneType)
		: normal(init::None)
	{
	}

    inline Plane::Plane(init::ZeroType)
		: normal(init::Zero)
		, dist(0.0f)
	{
	}

    inline Plane::Plane(init::IdentityType)
		: normal(0.0f, 1.0f, 0.0f)
		, dist(0.0f)
	{
	}

    inline Plane::Plane(Vec3 _normal, float _dist)
		: normal(_normal)
		, dist(_dist)
	{
	}
