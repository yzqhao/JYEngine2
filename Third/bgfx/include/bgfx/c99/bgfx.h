...
/**
* Renderer device feature level enum.
*
*/
typedef enum bgfx_device_feature_level
{
    /** Feature level of OpenGL ES2. */
    ES2,

    /** Feature level of OpenGL ES3.0. */
    ES3_0,

    /** Feature level of OpenGL ES3.1. */
    ES3_1,

    /** Feature level of OpenGL ES3.2. */
    ES3_2,

    /** Feature level of DX10. */
    SM4,

    /** Feature level of DX11. */
    SM5,
    Count
} bgfx_device_feature_level_t;
...
typedef enum bgfx_uniform_type
{
    ...
    BGFX_UNIFORM_TYPE_FLOAT,                  /** ( 2) 1 floats vector/               */
    ...
    BGFX_UNIFORM_TYPE_BUFFER,
    BGFX_UNIFORM_TYPE_CONSTBUFFER,            /** const buffer */
...
typedef struct bgfx_caps_limits_s
{
    ...
    uint32_t             maxVertexTextureImage;   /** Maximum vertex texture image units. */
...
typedef struct bgfx_caps_s
{
    ...
    bgfx_device_feature_level_t featurelevel;
...
typedef struct bgfx_texture_info_s
{
    ...
    bool				 autoGenMaipmap;     //!< Auto gen mipmap. 
    int32_t				 refHandle;          //!< Ref handle
 ...
 *
 */
BGFX_C_API void bgfx_calc_texture_size(bgfx_texture_info_t * _info, uint16_t _width, uint16_t _height, uint16_t _depth, bool _cubeMap, bool _hasMips, uint16_t _numLayers, bgfx_texture_format_t _format, bool autoGenMipmap, int32_t refHandle);
...
struct bgfx_interface_vtbl
{
    ...
    void (*calc_texture_size)(bgfx_texture_info_t * _info, uint16_t _width, uint16_t _height, uint16_t _depth, bool _cubeMap, bool _hasMips, uint16_t _numLayers, bgfx_texture_format_t _format, bool autoGenMipmap, int32_t refHandle);
