...
#define BGFX_CAPS_SHADOW_SAMPLER					UINT64_C(0x0000000000000001)
#define BGFX_CAPS_SRGB								UINT64_C(0x0000000000000002) //!< Frame buffer sRGB is supported.
#define BGFX_CAPS_FRAMEBUFFER_FETCH					UINT64_C(0x0000000000000004) //!< Framebuffer fetch is supported
#define BGFX_CAPS_FRAMEBUFFER_HALF					UINT64_C(0x0000000000000008) //!< half-float framebuffer is supported
#define BGFX_CAPS_FRAMEBUFFER_FLOAT					UINT64_C(0x0000000000000010) //!< floating-point framebuffer is supported
#define BGFX_CAPS_PIXEL_LOCAL_STORAGE				UINT64_C(0x0000000000000020) //!< pixel local storage is supported
#define BGFX_CAPS_FRAMEBUFFER_FETCH_DEPTH_STENCIL	UINT64_C(0x0000000000000040) //!< Framebuffer fetch depth stencil is supported
#define BGFX_CAPS_MRT_FRAMEBUFFER_FETCH				UINT64_C(0x0000000000000080) //!< MRT Framebuffer fetch is supported
