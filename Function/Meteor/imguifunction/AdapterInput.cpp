...
void AdapterInput::_OnCreate()
{
	...
	IApplication::Instance()->SetTouchCallback(MulticastDelegate<const TouchInputs&>::DelegateT::CreateRaw(this, &AdapterInput::OnTouch));
	IApplication::Instance()->SetKeyboardCallback(MulticastDelegate<InputPropery::Keyboard, InputPropery::KeyStatus>::DelegateT::CreateRaw(this, &AdapterInput::OnKeyboard));
	IApplication::Instance()->SetCharCallback(MulticastDelegate<uint>::DelegateT::CreateRaw(this, &AdapterInput::OnChar));
	IApplication::Instance()->SetScrollCallback(MulticastDelegate<float, float>::DelegateT::CreateRaw(this, &AdapterInput::OnScroll));
}
