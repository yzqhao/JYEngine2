	...
	, m_rpImGuiViewport(vp)
{
	...
	m_rpHostWindow->SetWindowCloseCallback(DelegateEvent<void(void*)>::Handler::FromMethod<AdapterWindow, &AdapterWindow::OnWindowClose>(this));
	m_rpHostWindow->SetWindowMoveCallback(DelegateEvent<void(void*)>::Handler::FromMethod<AdapterWindow, &AdapterWindow::OnWindowMove>(this));
}
